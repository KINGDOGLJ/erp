  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20"
        ...
        <el-col :span="8">
          <el-input placeholder="请输入客户编号/名称/联系人/电话查询"
    ...
    <!-- 保存客户对话框 -->
    <el-dialog :title="isAdd ? '新增客户' : '修改客户'"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="客户等级"
                          prop="level">
              <el-select v-model="saveForm.level"
                         placeholder="请选择"
                         clearable>
  ...
  data() {
    return {
      ...
      saveFormRules: {
        ...
        level: [{ required: true, message: '请选择客户等级', trigger: 'blur' }]
      },
      // 是否新增联系人
      isContactAdd: true,
